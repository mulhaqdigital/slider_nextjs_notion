...
export default function LogoCloud() {
    ...
    return (
        <section className="bg-background overflow-hidden py-4 sm:py-2 md:py-3 lg:py-4">
            <div className="group relative m-auto max-w-7xl px-3 sm:px-4 md:px-6">
                <div className="flex flex-col items-center space-y-3 sm:space-y-4 md:space-y-0 md:flex-row">
                    ...
                    <div className="max-w-screen py-3 sm:py-4 md:py-6 w-full 
